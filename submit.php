...
<body>
  ...
  <div class="navbar-fixed" style="margin-top: 0px;">
    ...
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li class='margin-2'><a href="products.html"><p class='p'>Projects</p></a></li>
    </ul>
  ...
  <ul class='sidenav' id='mobile-nav' style="margin-top: 20px; margin-left: -100px; text-align: center;">
    <li class='color'><a  href="index.html"><p class='col'>About</p></a></li>
        <li class='color'><a  href="#projects"><p class='color'>Projects</p></a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="well well-sm">
                    <h1 style="color:#3b7f25;text-align: center;">
                    <?php
